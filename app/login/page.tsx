...
export default function LoginPage() {
  return (
    <main className="min-h-screen grid grid-cols-1 md:grid-cols-2">
      ...
      {/* LEFT SIDE: The Visual (Hidden on mobile) */}
      ...
      <div className="flex flex-col justify-center items-center p-8 bg-white">
        <div className="w-full max-w-md space-y-8">
            ...
            <div className="space-y-4">
                ...
                <button className="w-full flex items-center justify-center gap-3 p-4 rounded-xl border-2 border-brand-dark bg-brand-dark text-white font-bold hover:bg-gray-800 transition-all hover:scale-[1.02]">
                    <Wallet size={20} />
                    Sign in with Wallet
                </button>
                ...
                <button className="w-full flex items-center justify-center gap-3 p-4 rounded-xl border border-gray-200 text-brand-dark font-bold hover:border-brand-primary hover:text-brand-primary hover:bg-brand-bg transition-all">
                    <Mail size={20} />
                    Sign in with Email
                </button>
            </div>
